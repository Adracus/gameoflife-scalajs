...
/** @constructor */
var $c_Lgameoflife_component_GameBuilder = (function() {
  $c_O.call(this);
  this.$$undsize$1 = 0;
  this.fields$1 = null
});
$c_Lgameoflife_component_GameBuilder.prototype = new $h_O();
$c_Lgameoflife_component_GameBuilder.prototype.constructor = $c_Lgameoflife_component_GameBuilder;
/** @constructor */
var $h_Lgameoflife_component_GameBuilder = (function() {
  /*<skip>*/
});
$h_Lgameoflife_component_GameBuilder.prototype = $c_Lgameoflife_component_GameBuilder.prototype;
$c_Lgameoflife_component_GameBuilder.prototype.size$und$eq__I__V = (function(value) {
  this.checkSize__I__V(value);
  this.$$undsize$1 = value;
  this.fields$1 = $asArrayOf_Z($m_s_Array$().ofDim__I__I__s_reflect_ClassTag__AO(this.$$undsize$1, this.$$undsize$1, $m_s_reflect_ClassTag$().Boolean$1), 2)
});
$c_Lgameoflife_component_GameBuilder.prototype.init___I = (function(initialSize) {
  this.checkSize__I__V(initialSize);
  this.$$undsize$1 = initialSize;
  this.fields$1 = $asArrayOf_Z($m_s_Array$().ofDim__I__I__s_reflect_ClassTag__AO(this.$$undsize$1, this.$$undsize$1, $m_s_reflect_ClassTag$().Boolean$1), 2);
  return this
});
$c_Lgameoflife_component_GameBuilder.prototype.set__Z__I__I__V = (function(value, x, y) {
  this.fields$1.u[x].u[y] = value
});
$c_Lgameoflife_component_GameBuilder.prototype.checkSize__I__V = (function(value) {
  if ((value <= 0)) {
    throw new $c_jl_IllegalArgumentException().init___T("Value has to be greater than 0")
  }
});
$c_Lgameoflife_component_GameBuilder.prototype.get__I__I__Z = (function(x, y) {
  return this.fields$1.u[x].u[y]
});
$c_Lgameoflife_component_GameBuilder.prototype.clear__V = (function() {
  this.fields$1 = $asArrayOf_Z($m_s_Array$().ofDim__I__I__s_reflect_ClassTag__AO(this.$$undsize$1, this.$$undsize$1, $m_s_reflect_ClassTag$().Boolean$1), 2)
});
$c_Lgameoflife_component_GameBuilder.prototype.invert__I__I__V = (function(x, y) {
  this.set__Z__I__I__V((!this.get__I__I__Z(x, y)), x, y)
});
var $d_Lgameoflife_component_GameBuilder = new $ClassTypeData({
  Lgameoflife_component_GameBuilder: 0
}, false, "gameoflife.component.GameBuilder", {
  Lgameoflife_component_GameBuilder: 1,
  O: 1
});
$c_Lgameoflife_component_GameBuilder.prototype.$classData = $d_Lgameoflife_component_GameBuilder;
/** @constructor */
var $c_Lgameoflife_component_GameComponent = (function() {
  $c_O.call(this);
  this.canvas$1 = null;
  this.blockSize$1 = 0;
  this.builder$1 = null;
  ...
  this.field$1 = null;
  this.handlerId$1 = null
});
$c_Lgameoflife_component_GameComponent.prototype = new $h_O();
$c_Lgameoflife_component_GameComponent.prototype.constructor = $c_Lgameoflife_component_GameComponent;
/** @constructor */
var $h_Lgameoflife_component_GameComponent = (function() {
  /*<skip>*/
});
$h_Lgameoflife_component_GameComponent.prototype = $c_Lgameoflife_component_GameComponent.prototype;
$c_Lgameoflife_component_GameComponent.prototype.draw__p1__V = (function() {
  if (this.handlerId$1.isDefined__Z()) {
    this.renderer$1.draw__AAZ__V($as_Lgameoflife_gamefield_GameField(this.field$1.get__O()).field$1);
    return (void 0)
  };
  this.renderer$1.draw__AAZ__V(this.builder$1.fields$1)
});
$c_Lgameoflife_component_GameComponent.prototype.start__V = (function() {
  this.stop__V();
  var this$1 = this.builder$1;
  this.field$1 = new $c_s_Some().init___O(new $c_Lgameoflife_gamefield_GameField().init___AAZ__Lgameoflife_core_RuleEngine(this$1.fields$1, new $c_Lgameoflife_core_DefaultRuleEngine().init___()));
  this.handlerId$1 = new $c_s_Some().init___O($uI($g["setInterval"]((function(arg$outer) {
    return (function() {
      arg$outer.gameoflife$component$GameComponent$$tick__V()
    })
  })(this), 1000.0)))
});
$c_Lgameoflife_component_GameComponent.prototype.init___Lorg_scalajs_dom_raw_HTMLCanvasElement__I = (function(canvas, blockSize) {
  this.canvas$1 = canvas;
  this.blockSize$1 = blockSize;
  this.builder$1 = new $c_Lgameoflife_component_GameBuilder().init___I(23);
  this.renderer$1 = new $c_Lgameoflife_graphics_Renderer().init___Lorg_scalajs_dom_raw_HTMLCanvasElement(canvas);
  this.field$1 = $m_s_None$();
  this.handlerId$1 = $m_s_None$();
  this.draw__p1__V();
  this.renderer$1.draw__AAZ__V(this.builder$1.fields$1);
  canvas["onclick"] = (function(arg$outer) {
    return (function(event$2) {
      arg$outer.onClick__Lorg_scalajs_dom_raw_MouseEvent__V(event$2)
    })
  })(this);
  return this
});
$c_Lgameoflife_component_GameComponent.prototype.cellWidth__I = (function() {
  var jsx$1 = $uI(this.canvas$1["width"]);
  var this$1 = this.builder$1;
  return ((jsx$1 / this$1.$$undsize$1) | 0)
});
$c_Lgameoflife_component_GameComponent.prototype.cellHeight__I = (function() {
  var jsx$1 = $uI(this.canvas$1["height"]);
  var this$1 = this.builder$1;
  return ((jsx$1 / this$1.$$undsize$1) | 0)
});
$c_Lgameoflife_component_GameComponent.prototype.stop__V = (function() {
  if (this.handlerId$1.isDefined__Z()) {
    $g["clearInterval"]($uI(this.handlerId$1.get__O()));
    this.handlerId$1 = $m_s_None$()
  };
  if (this.field$1.isDefined__Z()) {
    this.builder$1.fields$1 = $as_Lgameoflife_gamefield_GameField(this.field$1.get__O()).field$1
  }
});
$c_Lgameoflife_component_GameComponent.prototype.onClick__Lorg_scalajs_dom_raw_MouseEvent__V = (function(event) {
  this.stop__V();
  var rect = this.canvas$1["getBoundingClientRect"]();
  var this$1 = this.builder$1;
  var pos = this.interpolate__D__D__T2(($uD(event["clientX"]) - $uD(rect["left"])), ($uD(event["clientY"]) - $uD(rect["top"])));
  this$1.invert__I__I__V(pos.$$und1$mcI$sp__I(), pos.$$und2$mcI$sp__I());
  this.draw__p1__V()
});
$c_Lgameoflife_component_GameComponent.prototype.random__V = (function() {
  this.stop__V();
  var jsx$2 = $m_Lgameoflife_gamefield_GameField$();
  var this$1 = this.builder$1;
  var jsx$1 = this$1.$$undsize$1;
  var this$2 = this.builder$1;
  this.field$1 = new $c_s_Some().init___O(jsx$2.random__I__I__Lgameoflife_core_RuleEngine__Lgameoflife_gamefield_GameField(jsx$1, this$2.$$undsize$1, new $c_Lgameoflife_core_DefaultRuleEngine().init___()));
  this.builder$1.fields$1 = $as_Lgameoflife_gamefield_GameField(this.field$1.get__O()).field$1;
  this.draw__p1__V()
});
$c_Lgameoflife_component_GameComponent.prototype.setSize__I__V = (function(size) {
  this.builder$1.size$und$eq__I__V(size);
  var this$1 = this.builder$1;
  this.field$1 = new $c_s_Some().init___O(new $c_Lgameoflife_gamefield_GameField().init___AAZ__Lgameoflife_core_RuleEngine(this$1.fields$1, new $c_Lgameoflife_core_DefaultRuleEngine().init___()));
  this.draw__p1__V()
});
$c_Lgameoflife_component_GameComponent.prototype.clear__V = (function() {
  this.stop__V();
  this.builder$1.clear__V();
  var this$1 = this.builder$1;
  this.field$1 = new $c_s_Some().init___O(new $c_Lgameoflife_gamefield_GameField().init___AAZ__Lgameoflife_core_RuleEngine(this$1.fields$1, new $c_Lgameoflife_core_DefaultRuleEngine().init___()));
  this.draw__p1__V()
});
$c_Lgameoflife_component_GameComponent.prototype.interpolate__D__D__T2 = (function(x, y) {
  var xPos = (x / this.cellWidth__I());
  var yPos = (y / this.cellHeight__I());
  return new $c_s_Tuple2$mcII$sp().init___I__I((xPos | 0), (yPos | 0))
});
$c_Lgameoflife_component_GameComponent.prototype.gameoflife$component$GameComponent$$tick__V = (function() {
  if ((!$as_Lgameoflife_gamefield_GameField(this.field$1.get__O()).hasNext__Z())) {
    this.stop__V();
    return (void 0)
  };
  this.field$1 = new $c_s_Some().init___O($as_Lgameoflife_gamefield_GameField(this.field$1.get__O()).next__Lgameoflife_gamefield_GameField());
  this.draw__p1__V()
});
var $d_Lgameoflife_component_GameComponent = new $ClassTypeData({
  Lgameoflife_component_GameComponent: 0
}, false, "gameoflife.component.GameComponent", {
  Lgameoflife_component_GameComponent: 1,
  O: 1
});
$c_Lgameoflife_component_GameComponent.prototype.$classData = $d_Lgameoflife_component_GameComponent;
/** @constructor */
var $c_Lgameoflife_gamefield_GameField = (function() {
  $c_O.call(this);
  this.field$1 = null;
  this.gameoflife$gamefield$GameField$$ruleEngine$1 = null
});
$c_Lgameoflife_gamefield_GameField.prototype = new $h_O();
$c_Lgameoflife_gamefield_GameField.prototype.constructor = $c_Lgameoflife_gamefield_GameField;
/** @constructor */
var $h_Lgameoflife_gamefield_GameField = (function() {
  /*<skip>*/
});
$h_Lgameoflife_gamefield_GameField.prototype = $c_Lgameoflife_gamefield_GameField.prototype;
$c_Lgameoflife_gamefield_GameField.prototype.init___AAZ__Lgameoflife_core_RuleEngine = (function(field, ruleEngine) {
  this.field$1 = field;
  this.gameoflife$gamefield$GameField$$ruleEngine$1 = ruleEngine;
  return this
});
$c_Lgameoflife_gamefield_GameField.prototype.width__I = (function() {
  return this.field$1.u["length"]
});
$c_Lgameoflife_gamefield_GameField.prototype.next__Lgameoflife_gamefield_GameField = (function() {
  var result = $asArrayOf_Z($m_s_Array$().ofDim__I__I__s_reflect_ClassTag__AO(this.width__I(), this.height__I(), $m_s_reflect_ClassTag$().Boolean$1), 2);
  var end = this.width__I();
  var isEmpty$4 = (end <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : end);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + end) | 0));
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  var f = new $c_Lgameoflife_gamefield_GameField$$anonfun$next$1().init___Lgameoflife_gamefield_GameField__AAZ(this, result);
  ...
  return new $c_Lgameoflife_gamefield_GameField().init___AAZ__Lgameoflife_core_RuleEngine(result, new $c_Lgameoflife_core_DefaultRuleEngine().init___())
});
$c_Lgameoflife_gamefield_GameField.prototype.height__I = (function() {
  return ((this.field$1.u["length"] === 0) ? 0 : this.field$1.u[0].u["length"])
});
$c_Lgameoflife_gamefield_GameField.prototype.hasNext__Z = (function() {
  return (!this.isEverythingDead__p1__Z())
});
$c_Lgameoflife_gamefield_GameField.prototype.neighbours__p1__I__I__sc_Seq = (function(x, y) {
  var values = new $c_scm_ListBuffer().init___();
  if (this.inRange__I__I__Z((((-1) + x) | 0), y)) {
    var x$1 = (((-1) + x) | 0);
    var elems = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.apply__I__I__Z(x$1, y)]);
    values.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(elems)
  };
  if (this.inRange__I__I__Z((((-1) + x) | 0), (((-1) + y) | 0))) {
    var x$2 = (((-1) + x) | 0);
    var y$1 = (((-1) + y) | 0);
    var elems$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.apply__I__I__Z(x$2, y$1)]);
    values.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(elems$1)
  };
  if (this.inRange__I__I__Z(x, (((-1) + y) | 0))) {
    var y$2 = (((-1) + y) | 0);
    var elems$2 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.apply__I__I__Z(x, y$2)]);
    values.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(elems$2)
  };
  if (this.inRange__I__I__Z(((1 + x) | 0), (((-1) + y) | 0))) {
    var x$3 = ((1 + x) | 0);
    var y$3 = (((-1) + y) | 0);
    var elems$3 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.apply__I__I__Z(x$3, y$3)]);
    values.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(elems$3)
  };
  if (this.inRange__I__I__Z(((1 + x) | 0), y)) {
    var x$4 = ((1 + x) | 0);
    var elems$4 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.apply__I__I__Z(x$4, y)]);
    values.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(elems$4)
  };
  if (this.inRange__I__I__Z(((1 + x) | 0), ((1 + y) | 0))) {
    var x$5 = ((1 + x) | 0);
    var y$4 = ((1 + y) | 0);
    var elems$5 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.apply__I__I__Z(x$5, y$4)]);
    values.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(elems$5)
  };
  if (this.inRange__I__I__Z(x, ((1 + y) | 0))) {
    var y$5 = ((1 + y) | 0);
    var elems$6 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.apply__I__I__Z(x, y$5)]);
    values.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(elems$6)
  };
  if (this.inRange__I__I__Z((((-1) + x) | 0), ((1 + y) | 0))) {
    var x$6 = (((-1) + x) | 0);
    var y$6 = ((1 + y) | 0);
    var elems$7 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.apply__I__I__Z(x$6, y$6)]);
    values.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(elems$7)
  };
  return values.toList__sci_List()
});
$c_Lgameoflife_gamefield_GameField.prototype.apply__I__I__Z = (function(x, y) {
  return this.field$1.u[x].u[y]
});
$c_Lgameoflife_gamefield_GameField.prototype.gameoflife$gamefield$GameField$$livingNeighbours__I__I__I = (function(x, y) {
  var ns = this.neighbours__p1__I__I__sc_Seq(x, y);
  return $as_sc_SeqLike(ns.filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$3$2) {
    var x$3 = $uZ(x$3$2);
    return x$3
  })))).length__I()
});
$c_Lgameoflife_gamefield_GameField.prototype.inRange__I__I__Z = (function(x, y) {
  return ((((x >= 0) && (x < this.width__I())) && (y >= 0)) && (y < this.height__I()))
});
$c_Lgameoflife_gamefield_GameField.prototype.isEverythingDead__p1__Z = (function() {
  var xs = this.field$1;
  var i = 0;
  while (true) {
    if ((i < xs.u["length"])) {
...
var $is_Lgameoflife_gamefield_GameField = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgameoflife_gamefield_GameField)))
});
var $as_Lgameoflife_gamefield_GameField = (function(obj) {
  return (($is_Lgameoflife_gamefield_GameField(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "gameoflife.gamefield.GameField"))
});
var $isArrayOf_Lgameoflife_gamefield_GameField = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgameoflife_gamefield_GameField)))
});
var $asArrayOf_Lgameoflife_gamefield_GameField = (function(obj, depth) {
  return (($isArrayOf_Lgameoflife_gamefield_GameField(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lgameoflife.gamefield.GameField;", depth))
});
var $d_Lgameoflife_gamefield_GameField = new $ClassTypeData({
  Lgameoflife_gamefield_GameField: 0
}, false, "gameoflife.gamefield.GameField", {
  Lgameoflife_gamefield_GameField: 1,
  O: 1
});
$c_Lgameoflife_gamefield_GameField.prototype.$classData = $d_Lgameoflife_gamefield_GameField;
/** @constructor */
var $c_Lgameoflife_gamefield_GameField$ = (function() {
  $c_O.call(this)
});
...
$h_Lgameoflife_gamefield_GameField$.prototype = $c_Lgameoflife_gamefield_GameField$.prototype;
$c_Lgameoflife_gamefield_GameField$.prototype.random__I__I__Lgameoflife_core_RuleEngine__Lgameoflife_gamefield_GameField = (function(x, y, ruleEngine) {
  var random = new $c_s_util_Random().init___();
  var fields = $asArrayOf_Z($m_s_Array$().ofDim__I__I__s_reflect_ClassTag__AO(x, y, $m_s_reflect_ClassTag$().Boolean$1), 2);
  var isEmpty$4 = (x <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : x);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + x) | 0));
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  var f = new $c_Lgameoflife_gamefield_GameField$$anonfun$random$1().init___I__s_util_Random__AAZ(y, random, fields);
  if ((numRangeElements$4 < 0)) {
    $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(0, x, 1, false)
  };
  var i = 0;
  var count = 0;
  while ((i !== terminalElement$4)) {
  ...
  return new $c_Lgameoflife_gamefield_GameField().init___AAZ__Lgameoflife_core_RuleEngine(fields, ruleEngine)
});
var $d_Lgameoflife_gamefield_GameField$ = new $ClassTypeData({
  Lgameoflife_gamefield_GameField$: 0
}, false, "gameoflife.gamefield.GameField$", {
...
$c_Lgameoflife_gamefield_GameField$.prototype.$classData = $d_Lgameoflife_gamefield_GameField$;
var $n_Lgameoflife_gamefield_GameField$ = (void 0);
var $m_Lgameoflife_gamefield_GameField$ = (function() {
  if ((!$n_Lgameoflife_gamefield_GameField$)) {
    $n_Lgameoflife_gamefield_GameField$ = new $c_Lgameoflife_gamefield_GameField$().init___()
  };
  return $n_Lgameoflife_gamefield_GameField$
});
/** @constructor */
var $c_Lgameoflife_graphics_Renderer = (function() {
  $c_O.call(this);
  this.canvas$1 = null;
  this.ctx$1 = null
});
$c_Lgameoflife_graphics_Renderer.prototype = new $h_O();
$c_Lgameoflife_graphics_Renderer.prototype.constructor = $c_Lgameoflife_graphics_Renderer;
/** @constructor */
var $h_Lgameoflife_graphics_Renderer = (function() {
  /*<skip>*/
});
$h_Lgameoflife_graphics_Renderer.prototype = $c_Lgameoflife_graphics_Renderer.prototype;
$c_Lgameoflife_graphics_Renderer.prototype.getXRatio__p1__AAZ__D = (function(fields) {
  return (this.width__p1__I() / fields.u["length"])
});
$c_Lgameoflife_graphics_Renderer.prototype.init___Lorg_scalajs_dom_raw_HTMLCanvasElement = (function(canvas) {
  this.canvas$1 = canvas;
  this.ctx$1 = canvas["getContext"]("2d");
  return this
});
$c_Lgameoflife_graphics_Renderer.prototype.getRatio__p1__AAZ__T2 = (function(fields) {
  return new $c_s_Tuple2$mcDD$sp().init___D__D(this.getXRatio__p1__AAZ__D(fields), this.getYRatio__p1__AAZ__D(fields))
});
$c_Lgameoflife_graphics_Renderer.prototype.getYRatio__p1__AAZ__D = (function(fields) {
  return (this.height__p1__I() / fields.u[0].u["length"])
});
$c_Lgameoflife_graphics_Renderer.prototype.draw__AAZ__V = (function(fields) {
  var ratio = this.getRatio__p1__AAZ__T2(fields);
  var cellWidth = (ratio.$$und1$mcD$sp__D() | 0);
  var cellHeight = (ratio.$$und2$mcD$sp__D() | 0);
  var color = $m_Lgameoflife_graphics_Color$().White$2;
  this.gameoflife$graphics$Renderer$$fillRectangle__I__I__I__I__Lgameoflife_graphics_Color__V(0, 0, this.width__p1__I(), this.height__p1__I(), color);
  var end = fields.u["length"];
  var isEmpty$4 = (end <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : end);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + end) | 0));
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  var f = new $c_Lgameoflife_graphics_Renderer$$anonfun$draw$1().init___Lgameoflife_graphics_Renderer__AAZ__I__I(this, fields, cellWidth, cellHeight);
  if ((numRangeElements$4 < 0)) {
    $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(0, end, 1, false)
  };
  var i = 0;
...
$c_Lgameoflife_graphics_Renderer.prototype.width__p1__I = (function() {
  return $uI(this.canvas$1["width"])
});
$c_Lgameoflife_graphics_Renderer.prototype.gameoflife$graphics$Renderer$$fillRectangle__I__I__I__I__Lgameoflife_graphics_Color__V = (function(x, y, width, height, color) {
  var temp = this.ctx$1["fillStyle"];
  var jsx$1 = this.ctx$1;
  var s = color.toString__T();
  jsx$1["fillStyle"] = s;
  this.ctx$1["fillRect"](x, y, width, height);
  this.ctx$1["fillStyle"] = temp
});
$c_Lgameoflife_graphics_Renderer.prototype.height__p1__I = (function() {
  return $uI(this.canvas$1["height"])
});
var $d_Lgameoflife_graphics_Renderer = new $ClassTypeData({
  Lgameoflife_graphics_Renderer: 0
}, false, "gameoflife.graphics.Renderer", {
  Lgameoflife_graphics_Renderer: 1,
  O: 1
});
$c_Lgameoflife_graphics_Renderer.prototype.$classData = $d_Lgameoflife_graphics_Renderer;
/** @constructor */
...
/** @constructor */
var $c_Lgameoflife_core_DefaultRuleEngine = (function() {
  $c_O.call(this)
});
$c_Lgameoflife_core_DefaultRuleEngine.prototype = new $h_O();
$c_Lgameoflife_core_DefaultRuleEngine.prototype.constructor = $c_Lgameoflife_core_DefaultRuleEngine;
/** @constructor */
var $h_Lgameoflife_core_DefaultRuleEngine = (function() {
  /*<skip>*/
});
$h_Lgameoflife_core_DefaultRuleEngine.prototype = $c_Lgameoflife_core_DefaultRuleEngine.prototype;
$c_Lgameoflife_core_DefaultRuleEngine.prototype.nextState__Z__I__Z = (function(current, aliveNeighbours) {
...
var $d_Lgameoflife_core_DefaultRuleEngine = new $ClassTypeData({
  Lgameoflife_core_DefaultRuleEngine: 0
}, false, "gameoflife.core.DefaultRuleEngine", {
  Lgameoflife_core_DefaultRuleEngine: 1,
  O: 1,
  Lgameoflife_core_RuleEngine: 1
});
$c_Lgameoflife_core_DefaultRuleEngine.prototype.$classData = $d_Lgameoflife_core_DefaultRuleEngine;
/** @constructor */
var $c_Lgameoflife_core_Main$ = (function() {
  $c_O.call(this)
});
$c_Lgameoflife_core_Main$.prototype = new $h_O();
$c_Lgameoflife_core_Main$.prototype.constructor = $c_Lgameoflife_core_Main$;
/** @constructor */
var $h_Lgameoflife_core_Main$ = (function() {
  /*<skip>*/
});
$h_Lgameoflife_core_Main$.prototype = $c_Lgameoflife_core_Main$.prototype;
$c_Lgameoflife_core_Main$.prototype.init___ = (function() {
  $n_Lgameoflife_core_Main$ = this;
  return this
});
$c_Lgameoflife_core_Main$.prototype.main__V = (function() {
  var canvas = $g["document"]["querySelector"]("#canvas");
  var toggleButton = $g["document"]["querySelector"]("#toggle");
  var clearButton = $g["document"]["querySelector"]("#clear");
  var updateButton = $g["document"]["querySelector"]("#update");
  var randomButton = $g["document"]["querySelector"]("#random");
  var sizeInput = $g["document"]["querySelector"]("#size");
  var game = new $c_Lgameoflife_component_GameComponent().init___Lorg_scalajs_dom_raw_HTMLCanvasElement__I(canvas, 16);
  $g["document"]["onreadystatechange"] = (function(toggleButton$1, clearButton$1, updateButton$1, randomButton$1, sizeInput$1, game$1) {
    return (function(x$1$2) {
      $m_Lgameoflife_core_Main$().gameoflife$core$Main$$ready$1__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLInputElement__Lgameoflife_component_GameComponent__V(toggleButton$1, clearButton$1, updateButton$1, randomButton$1, sizeInput$1, game$1)
    })
  })(toggleButton, clearButton, updateButton, randomButton, sizeInput, game)
});
$c_Lgameoflife_core_Main$.prototype.gameoflife$core$Main$$ready$1__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLButtonElement__Lorg_scalajs_dom_raw_HTMLInputElement__Lgameoflife_component_GameComponent__V = (function(toggleButton$1, clearButton$1, updateButton$1, randomButton$1, sizeInput$1, game$1) {
  if (($as_T($g["document"]["readyState"]) === "complete")) {
    updateButton$1["onclick"] = (function(sizeInput$1$1, game$1$1) {
      return (function(x$2$2) {
        $m_Lgameoflife_core_Main$().gameoflife$core$Main$$update$1__Lorg_scalajs_dom_raw_HTMLInputElement__Lgameoflife_component_GameComponent__V(sizeInput$1$1, game$1$1)
      })
    })(sizeInput$1, game$1);
    clearButton$1["onclick"] = (function(game$1$2) {
      return (function(x$3$2) {
        game$1$2.clear__V()
      })
    })(game$1);
    toggleButton$1["onclick"] = (function(game$1$3) {
      return (function(x$4$2) {
        game$1$3.start__V()
      })
    })(game$1);
    randomButton$1["onclick"] = (function(game$1$4) {
...
$c_Lgameoflife_core_Main$.prototype.gameoflife$core$Main$$update$1__Lorg_scalajs_dom_raw_HTMLInputElement__Lgameoflife_component_GameComponent__V = (function(sizeInput$1, game$1) {
  var this$2 = new $c_sci_StringOps().init___T($as_T(sizeInput$1["value"]));
  var this$4 = $m_jl_Integer$();
  var s = this$2.repr$1;
  var value = this$4.parseInt__T__I__I(s, 10);
  game$1.setSize__I__V(value)
});
$c_Lgameoflife_core_Main$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lgameoflife_core_Main$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lgameoflife_core_Main$ = new $ClassTypeData({
  Lgameoflife_core_Main$: 0
}, false, "gameoflife.core.Main$", {
  Lgameoflife_core_Main$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lgameoflife_core_Main$.prototype.$classData = $d_Lgameoflife_core_Main$;
var $n_Lgameoflife_core_Main$ = (void 0);
var $m_Lgameoflife_core_Main$ = (function() {
  if ((!$n_Lgameoflife_core_Main$)) {
    $n_Lgameoflife_core_Main$ = new $c_Lgameoflife_core_Main$().init___()
  };
  return $n_Lgameoflife_core_Main$
});
$e["gameoflife"] = ($e["gameoflife"] || {});
$e["gameoflife"]["core"] = ($e["gameoflife"]["core"] || {});
$e["gameoflife"]["core"]["Main"] = $m_Lgameoflife_core_Main$;
...
/** @constructor */
var $c_Lgameoflife_graphics_Color$ = (function() {
...
$c_Lgameoflife_graphics_Color$.prototype = new $h_s_Enumeration();
$c_Lgameoflife_graphics_Color$.prototype.constructor = $c_Lgameoflife_graphics_Color$;
/** @constructor */
var $h_Lgameoflife_graphics_Color$ = (function() {
  /*<skip>*/
});
$h_Lgameoflife_graphics_Color$.prototype = $c_Lgameoflife_graphics_Color$.prototype;
$c_Lgameoflife_graphics_Color$.prototype.init___ = (function() {
  $c_s_Enumeration.prototype.init___.call(this);
  $n_Lgameoflife_graphics_Color$ = this;
  this.Red$2 = new $c_Lgameoflife_graphics_Color().init___I__I__I__D(255, 0, 0, ($m_Lgameoflife_graphics_Color$(), 1.0));
  this.Blue$2 = new $c_Lgameoflife_graphics_Color().init___I__I__I__D(0, 255, 0, ($m_Lgameoflife_graphics_Color$(), 1.0));
  this.Green$2 = new $c_Lgameoflife_graphics_Color().init___I__I__I__D(0, 0, 255, ($m_Lgameoflife_graphics_Color$(), 1.0));
  this.White$2 = new $c_Lgameoflife_graphics_Color().init___I__I__I__D(255, 255, 255, ($m_Lgameoflife_graphics_Color$(), 1.0));
  this.Black$2 = new $c_Lgameoflife_graphics_Color().init___I__I__I__D(0, 0, 0, ($m_Lgameoflife_graphics_Color$(), 1.0));
  return this
});
var $d_Lgameoflife_graphics_Color$ = new $ClassTypeData({
  Lgameoflife_graphics_Color$: 0
}, false, "gameoflife.graphics.Color$", {
  Lgameoflife_graphics_Color$: 1,
  s_Enumeration: 1,
  O: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Lgameoflife_graphics_Color$.prototype.$classData = $d_Lgameoflife_graphics_Color$;
var $n_Lgameoflife_graphics_Color$ = (void 0);
var $m_Lgameoflife_graphics_Color$ = (function() {
  if ((!$n_Lgameoflife_graphics_Color$)) {
    $n_Lgameoflife_graphics_Color$ = new $c_Lgameoflife_graphics_Color$().init___()
  };
  return $n_Lgameoflife_graphics_Color$
});
/** @constructor */
...
$c_s_Array$.prototype.ofDim__I__I__s_reflect_ClassTag__AO = (function(n1, n2, evidence$4) {
  var arr = $asArrayOf_O($m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($m_sr_ScalaRunTime$().arrayClass__jl_Class__jl_Class(evidence$4.runtimeClass__jl_Class())).newArray__I__O(n1), 1);
  var isEmpty$4 = (n1 <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : n1);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + n1) | 0));
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  if ((numRangeElements$4 < 0)) {
    $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(0, n1, 1, false)
  };
  var i = 0;
  var count = 0;
  while ((i !== terminalElement$4)) {
    var v1 = i;
    arr.u[v1] = evidence$4.newArray__I__O(n2);
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  return arr
...
/** @constructor */
var $c_sr_AbstractFunction1$mcVI$sp = (function() {
  $c_sr_AbstractFunction1.call(this)
});
...
/** @constructor */
var $h_sr_AbstractFunction1$mcVI$sp = (function() {
  /*<skip>*/
});
...
$c_Lgameoflife_graphics_Color.prototype = new $h_O();
$c_Lgameoflife_graphics_Color.prototype.constructor = $c_Lgameoflife_graphics_Color;
/** @constructor */
var $h_Lgameoflife_graphics_Color = (function() {
  /*<skip>*/
...
$h_Lgameoflife_graphics_Color.prototype = $c_Lgameoflife_graphics_Color.prototype;
$c_Lgameoflife_graphics_Color.prototype.productPrefix__T = (function() {
  return "Color"
});
$c_Lgameoflife_graphics_Color.prototype.productArity__I = (function() {
  return 4
});
$c_Lgameoflife_graphics_Color.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lgameoflife_graphics_Color(x$1)) {
    var Color$1 = $as_Lgameoflife_graphics_Color(x$1);
    return ((((this.r$1 === Color$1.r$1) && (this.g$1 === Color$1.g$1)) && (this.b$1 === Color$1.b$1)) && (this.a$1 === Color$1.a$1))
  } else {
    return false
  }
});
$c_Lgameoflife_graphics_Color.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.r$1;
...
$c_Lgameoflife_graphics_Color.prototype.toString__T = (function() {
...
$c_Lgameoflife_graphics_Color.prototype.init___I__I__I__D = (function(r, g, b, a) {
  this.r$1 = r;
  this.g$1 = g;
  this.b$1 = b;
  this.a$1 = a;
...
$c_Lgameoflife_graphics_Color.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Lgameoflife_graphics_Color.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lgameoflife_graphics_Color = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lgameoflife_graphics_Color)))
});
var $as_Lgameoflife_graphics_Color = (function(obj) {
  return (($is_Lgameoflife_graphics_Color(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "gameoflife.graphics.Color"))
});
var $isArrayOf_Lgameoflife_graphics_Color = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lgameoflife_graphics_Color)))
});
var $asArrayOf_Lgameoflife_graphics_Color = (function(obj, depth) {
  return (($isArrayOf_Lgameoflife_graphics_Color(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lgameoflife.graphics.Color;", depth))
});
var $d_Lgameoflife_graphics_Color = new $ClassTypeData({
  Lgameoflife_graphics_Color: 0
}, false, "gameoflife.graphics.Color", {
...
/** @constructor */
var $c_Lgameoflife_gamefield_GameField$$anonfun$next$1 = (function() {
  $c_sr_AbstractFunction1$mcVI$sp.call(this);
  this.$$outer$3 = null;
  this.result$1$f = null
});
$c_Lgameoflife_gamefield_GameField$$anonfun$next$1.prototype = new $h_sr_AbstractFunction1$mcVI$sp();
$c_Lgameoflife_gamefield_GameField$$anonfun$next$1.prototype.constructor = $c_Lgameoflife_gamefield_GameField$$anonfun$next$1;
/** @constructor */
var $h_Lgameoflife_gamefield_GameField$$anonfun$next$1 = (function() {
  /*<skip>*/
});
$h_Lgameoflife_gamefield_GameField$$anonfun$next$1.prototype = $c_Lgameoflife_gamefield_GameField$$anonfun$next$1.prototype;
$c_Lgameoflife_gamefield_GameField$$anonfun$next$1.prototype.init___Lgameoflife_gamefield_GameField__AAZ = (function($$outer, result$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
...
$c_Lgameoflife_gamefield_GameField$$anonfun$next$1.prototype.apply__O__O = (function(v1) {
  var x = $uI(v1);
  this.apply$mcVI$sp__I__V(x)
});
$c_Lgameoflife_gamefield_GameField$$anonfun$next$1.prototype.apply$mcVI$sp__I__V = (function(x) {
  var end = this.$$outer$3.height__I();
  var isEmpty$4 = (end <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : end);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + end) | 0));
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  ...
  while ((i !== terminalElement$4)) {
    var v1 = i;
    var jsx$2 = this.result$1$f.u[x];
    var jsx$1 = this.$$outer$3.gameoflife$gamefield$GameField$$ruleEngine$1;
    var this$4 = this.$$outer$3;
    jsx$2.u[v1] = jsx$1.nextState__Z__I__Z(this$4.apply__I__I__Z(x, v1), this.$$outer$3.gameoflife$gamefield$GameField$$livingNeighbours__I__I__I(x, v1));
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  }
});
var $d_Lgameoflife_gamefield_GameField$$anonfun$next$1 = new $ClassTypeData({
  Lgameoflife_gamefield_GameField$$anonfun$next$1: 0
}, false, "gameoflife.gamefield.GameField$$anonfun$next$1", {
  Lgameoflife_gamefield_GameField$$anonfun$next$1: 1,
...
$c_Lgameoflife_gamefield_GameField$$anonfun$next$1.prototype.$classData = $d_Lgameoflife_gamefield_GameField$$anonfun$next$1;
/** @constructor */
var $c_Lgameoflife_gamefield_GameField$$anonfun$random$1 = (function() {
  $c_sr_AbstractFunction1$mcVI$sp.call(this);
  this.y$1$3 = 0;
  this.random$1$f = null;
  this.fields$1$f = null
});
$c_Lgameoflife_gamefield_GameField$$anonfun$random$1.prototype = new $h_sr_AbstractFunction1$mcVI$sp();
$c_Lgameoflife_gamefield_GameField$$anonfun$random$1.prototype.constructor = $c_Lgameoflife_gamefield_GameField$$anonfun$random$1;
/** @constructor */
var $h_Lgameoflife_gamefield_GameField$$anonfun$random$1 = (function() {
  /*<skip>*/
});
$h_Lgameoflife_gamefield_GameField$$anonfun$random$1.prototype = $c_Lgameoflife_gamefield_GameField$$anonfun$random$1.prototype;
$c_Lgameoflife_gamefield_GameField$$anonfun$random$1.prototype.apply__O__O = (function(v1) {
  var x = $uI(v1);
  this.apply$mcVI$sp__I__V(x)
});
$c_Lgameoflife_gamefield_GameField$$anonfun$random$1.prototype.apply$mcVI$sp__I__V = (function(x) {
  var end = this.y$1$3;
  var isEmpty$4 = (end <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : end);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + end) | 0));
  ...
  while ((i !== terminalElement$4)) {
    var v1 = i;
    var jsx$1 = this.fields$1$f.u[x];
    var this$4 = this.random$1$f;
    jsx$1.u[v1] = this$4.self$1.nextBoolean__Z();
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  }
});
$c_Lgameoflife_gamefield_GameField$$anonfun$random$1.prototype.init___I__s_util_Random__AAZ = (function(y$1, random$1, fields$1) {
  this.y$1$3 = y$1;
  this.random$1$f = random$1;
  this.fields$1$f = fields$1;
  return this
});
var $d_Lgameoflife_gamefield_GameField$$anonfun$random$1 = new $ClassTypeData({
  Lgameoflife_gamefield_GameField$$anonfun$random$1: 0
}, false, "gameoflife.gamefield.GameField$$anonfun$random$1", {
  Lgameoflife_gamefield_GameField$$anonfun$random$1: 1,
  sr_AbstractFunction1$mcVI$sp: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
...
$c_Lgameoflife_gamefield_GameField$$anonfun$random$1.prototype.$classData = $d_Lgameoflife_gamefield_GameField$$anonfun$random$1;
/** @constructor */
var $c_Lgameoflife_graphics_Renderer$$anonfun$draw$1 = (function() {
  $c_sr_AbstractFunction1$mcVI$sp.call(this);
  this.$$outer$3 = null;
  this.fields$1$f = null;
  this.cellWidth$1$f = 0;
  this.cellHeight$1$f = 0
});
$c_Lgameoflife_graphics_Renderer$$anonfun$draw$1.prototype = new $h_sr_AbstractFunction1$mcVI$sp();
$c_Lgameoflife_graphics_Renderer$$anonfun$draw$1.prototype.constructor = $c_Lgameoflife_graphics_Renderer$$anonfun$draw$1;
/** @constructor */
var $h_Lgameoflife_graphics_Renderer$$anonfun$draw$1 = (function() {
  /*<skip>*/
});
$h_Lgameoflife_graphics_Renderer$$anonfun$draw$1.prototype = $c_Lgameoflife_graphics_Renderer$$anonfun$draw$1.prototype;
$c_Lgameoflife_graphics_Renderer$$anonfun$draw$1.prototype.apply__O__O = (function(v1) {
  var x = $uI(v1);
  this.apply$mcVI$sp__I__V(x)
});
$c_Lgameoflife_graphics_Renderer$$anonfun$draw$1.prototype.apply$mcVI$sp__I__V = (function(x) {
  var end = this.fields$1$f.u[0].u["length"];
  var isEmpty$4 = (end <= 0);
  var numRangeElements$4 = (isEmpty$4 ? 0 : end);
  var lastElement$4 = (isEmpty$4 ? (-1) : (((-1) + end) | 0));
  var terminalElement$4 = ((1 + lastElement$4) | 0);
  ...
  while ((i !== terminalElement$4)) {
    var v1 = i;
    var color = (this.fields$1$f.u[x].u[v1] ? $m_Lgameoflife_graphics_Color$().Red$2 : $m_Lgameoflife_graphics_Color$().White$2);
    this.$$outer$3.gameoflife$graphics$Renderer$$fillRectangle__I__I__I__I__Lgameoflife_graphics_Color__V($imul(x, this.cellWidth$1$f), $imul(v1, this.cellHeight$1$f), this.cellWidth$1$f, this.cellHeight$1$f, color);
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  }
});
$c_Lgameoflife_graphics_Renderer$$anonfun$draw$1.prototype.init___Lgameoflife_graphics_Renderer__AAZ__I__I = (function($$outer, fields$1, cellWidth$1, cellHeight$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
  ...
  this.fields$1$f = fields$1;
  this.cellWidth$1$f = cellWidth$1;
  this.cellHeight$1$f = cellHeight$1;
  return this
});
var $d_Lgameoflife_graphics_Renderer$$anonfun$draw$1 = new $ClassTypeData({
  Lgameoflife_graphics_Renderer$$anonfun$draw$1: 0
}, false, "gameoflife.graphics.Renderer$$anonfun$draw$1", {
  Lgameoflife_graphics_Renderer$$anonfun$draw$1: 1,
  sr_AbstractFunction1$mcVI$sp: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
...
$c_Lgameoflife_graphics_Renderer$$anonfun$draw$1.prototype.$classData = $d_Lgameoflife_graphics_Renderer$$anonfun$draw$1;
/** @constructor */
...
var $d_s_Tuple2$mcDD$sp = new $ClassTypeData({
  s_Tuple2$mcDD$sp: 0
...
//# sourceMappingURL=gameoflife-fastopt.js.map
